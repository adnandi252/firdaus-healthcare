  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        @can('isAdmin')
          <li class="nav-item">
            <a class="nav-link text-white " href="{{route('userlist.doctor')}}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <span class="material-symbols-outlined text-white">
                  stethoscope_arrow
                  </span>
              </div>
              <span class="nav-link-text ms-1">Tabel Dokter</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white " href="{{route('userlist.pharmacist')}}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">receipt_long</i>
              </div>
              <span class="nav-link-text ms-1">Tabel Apoteker</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white " href="{{route('userlist.patient')}}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <span class="material-symbols-outlined">
                  patient_list
                  </span>
              </div>
              <span class="nav-link-text ms-1">Tabel Pasien</span>
            </a>
          </li>
        @endcan
        ...
        @can('isDoctor')
          <li class="nav-item">
            <a class="nav-link text-white " href="{{route('medicalrecordlist')}}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        @can('isPharmacist')
          <li class="nav-item">
            <a class="nav-link text-white " href="{{route('medicinelist')}}">
              <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">table_view</i>
              </div>
        ...
        if (event.key === 'Enter') {
          var input, filter, table, tr, td, i, txtValue;
            ...
            for (i = 0; i < tr.length; i++) {
                td = tr[i].getElementsByTagName("td")[0]; // Ganti indeks berdasarkan kolom yang ingin Anda cari
                if (td) {
